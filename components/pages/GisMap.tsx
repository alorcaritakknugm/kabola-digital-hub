...
export default function GisMap() {
  ...
  return (
    <>
      {/* Dark Hero Section Header (Unified Dark Hero) */}
      <section className="relative bg-forest pt-32 pb-28 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10 text-center">
          <SlideUp inView yOffset={30} duration={0.7}>
            ...
            <h1 className="font-title text-3xl sm:text-4xl md:text-5xl text-white mb-4 leading-tight">
            ...
            <div className="mt-6 flex items-center justify-center">
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3 rounded-full bg-kabola-teal text-white text-xs sm:text-sm font-semibold hover:bg-kabola-teal-dark transition-all duration-300 shadow-lg shadow-kabola-teal/20 hover:-translate-y-0.5 border border-white/10"
              >
      ...
      {/* Interactive Map & Gallery Section */}
      <section className="relative py-12 sm:py-16 overflow-hidden bg-sand">
                ...
                {MAP_ITEMS.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-xs font-semibold whitespace-nowrap shrink-0 transition-all border ${isSelected
              ...
              <div className="flex flex-col lg:flex-row">
                      ...
                      {MAP_ITEMS.map((item) => {
                        ...
                        return (
                          <button
                            key={item.id}
                            onClick={() => setSelectedMap(item)}
                            className={`w-full text-left p-2.5 rounded-xl transition-all flex items-start justify-between gap-2 border ${isSelected
                ...
                <div className="flex-1 flex flex-col min-w-0">
                  ...
                  <div
                    ...
                    className={`relative flex-1 bg-[#0D2E27] min-h-[300px] sm:min-h-[380px] md:min-h-[440px] overflow-hidden flex items-center justify-center p-2 sm:p-3 select-none ${zoomLevel > 1 ? (isDragging ? "cursor-grabbing" : "cursor-grab") : "cursor-default"
                      }`}
                  >
                  ...
                  {paginatedMaps.map((mapItem) => {
                    ...
                    return (
                      <div
                        ...
                        className={`group relative rounded-2xl sm:rounded-3xl overflow-hidden bg-white border shadow-[0_4px_24px_rgba(0,0,0,0.04)] hover:shadow-xl transition-all duration-500 flex flex-col justify-between cursor-pointer ${isSelected ? "border-kabola-teal ring-2 ring-kabola-teal/20" : "border-kabola-teal/10"
                          }`}
                      >
                        <div>
                          {/* Image Frame */}
              ...
              >
                  ...
                  {MAP_ITEMS.map((item) => {
                    ...
                    return (
                      <button
                        key={item.id}
                        onClick={() => setSelectedMap(item)}
                        className={`px-2.5 py-1 rounded-full text-[11px] font-semibold whitespace-nowrap shrink-0 transition-all border ${isSelected
                            ? "bg-kabola-teal text-white border-kabola-teal shadow-sm"
                            : "bg-white text-earth/70 border-earth/15 hover:border-kabola-teal/30"
                          }`}
                      >
                ...
                <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
                        ...
                        {MAP_ITEMS.map((item) => {
                          ...
                          return (
                            <button
                              key={item.id}
                              onClick={() => setSelectedMap(item)}
                              className={`w-full text-left p-3 rounded-xl transition-all flex items-start justify-between gap-2 border ${isSelected
                  ...
                  <div
                    ...
                    onMouseUp={handleMouseUp}
                    onMouseLeave={handleMouseUp}
                    className={`flex-1 flex flex-col bg-[#0D2E27] overflow-hidden relative p-2 sm:p-3 select-none ${zoomLevel > 1 ? (isDragging ? "cursor-grabbing" : "cursor-grab") : "cursor-default"
                      }`}
                  >
