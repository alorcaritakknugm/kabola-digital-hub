        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {features.map((item, i) => (
            ...
            >
              <Link
                href={item.href}
                className="group flex gap-5 bg-white rounded-2xl border border-kabola-teal/10 p-6 shadow-[0_2px_12px_rgba(25,141,141,0.05)] hover:shadow-[0_8px_32px_rgba(25,141,141,0.12)] hover:border-kabola-teal/25 hover:-translate-y-0.5 transition-all duration-300"
              >
                {/* Icon */}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-earth/50 text-sm leading-relaxed mb-3">{item.desc}</p>
                  <span className="inline-flex items-center gap-1 text-kabola-teal text-xs font-semibold opacity-0 group-hover:opacity-100 transition-all">
