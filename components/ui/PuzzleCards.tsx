...
export default function PuzzleCards({
  ...
  const pieces = [
    {
      id: "left",
      img: "/images/puzzle/piece puzzle left.png",
      value: luasWilayah,
      unit: "km²",
      label: "Luas Wilayah",
    },
    {
      id: "center",
      img: "/images/puzzle/piece puzzle center.png",
    ...
    {
      id: "right",
      img: "/images/puzzle/piece puzzle right.png",
      value: jumlahKK,
      unit: "KK",
  ...
  return (
    <div className="w-full space-y-4 font-body">
      {/* Container Background Teal Murni Solid (#198D8D) */}
          ...
          {pieces.map((piece, index) => (
            <motion.div
              ...
              className={`relative flex flex-col items-center justify-center transition-all duration-300 ${
                index === 1 ? "-mx-0 md:-mx-4 z-10" : "z-0"
              }`}
            >
              {/* Gambar PNG Puzzle Asli - Presisi & Rapi */}
