...
export const metadata: Metadata = {
  ...
  description:
    "Profil lengkap Desa Pante Deere sebagai desa pesisir yang indah di Kecamatan Kabola, Kabupaten Alor, NTT. Potensi wisata bahari, budaya pesisir, dan kehidupan nelayan. Program KKN-PPM UGM 2026.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Profil Desa Pante Deere di Kecamatan Kabola, Alor NTT.",
